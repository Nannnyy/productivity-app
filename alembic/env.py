...
if PASSWORD is None:
    raise ValueError("PASSWORD environment variable is not set. Please check your .env file.")
...
DATABASE_URL = f'postgresql://{USERNAME}:{PASSWORD_ENCODED}@{HOST}:{PORT}/{DATABASE}'
...
# Import all models must happen before this line
