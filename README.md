...
| Histórico | Lógica | Implementar lógica no resource de Pomodoro e Tarefas para salvar as concluidas no banco | Lu | Sim
|           | Frontend | Criar a renderização da página de histórico| Lu | Sim
